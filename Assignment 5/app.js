...
//     for(let i = 0; i<4;i++){
//         var tid;
//         var retrievedObject = localStorage.getItem('Table'+i);
//         var contentList = JSON.parse(retrievedObject);
//         let htmlString = "";

//         console.log("this is table id "+i);
...
//                         <td><input type=number id=quantity${contentList[a].key} class="quantity${contentList[a].key}" min=0  value="${contentList[a].quantity}" onchange="updateQuantity(${table[j-1]},${contentList[a].key})"></td> 
//                         <td><img class="trashicon" id="trashicon${contentList[a].key}" onclick="deleteItem('${j}',${contentList[a].key})" src="https://img.icons8.com/ios-glyphs/30/000000/filled-trash.png"/></td>
//                     </tr>`; 
//                     j++;   
//                 }
...
//         }
//         else{
//             document.getElementById("table-items").innerHTML = `<div style="margin : 22px 159px;font-size:25px">OrderNai&nbsp;list&nbsp;is&nbsp;empty</div>`;
//             document.querySelector('#total-price').textContent = table[i].price;
//         }
